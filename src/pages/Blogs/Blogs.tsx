...
const desc1: JSX.Element = (
	<i>
		"This blog is more than just a virtual space; it's a cozy corner where we can come together as Mongolian American college students and young professionals, share our stories, and support each other on this incredible journey..."
	</i>
);

const desc2: JSX.Element = (
	<i>
		"As the first impression is always important, your resume is the first impression you can make at the companies when applying for a job. According to the Ladders study, on average, recruiters spend 7.4 seconds on the initial screening of a resume..."
	</i>
);

function BlogCard({ image, title, desc, link }: BlogCardProps): JSX.Element {
	const intl = useIntl();
