...
function Program({ name, description, pageLink }: ProgramProps) {
  const intl = useIntl();
  return (
  ...
  return (
    <div className={"programsContainer"}>
      <div>
        ...
        <Program
          name={"Resume Boost"}
          description={intl.formatMessage({ id: "resumeBoostDesc" })}
          pageLink={"/programs/resume-boost-program"}
        />
        <Program
          name={"Workshop"}
          description={intl.formatMessage({ id: "workshopDesc" })}
          pageLink={"/programs/cultural-compass-program"}
        />
      </div>
