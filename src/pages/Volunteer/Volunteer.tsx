...
import { VolunteerCard, VolunteerCardMobile } from "./Card";
  ...
  return (
    <div className="volunteerContainer">
      ...
      <div className="volunteerCardContainer only-desktop">
        <VolunteerCard
          flip={true}
          title={intl.formatMessage({ id: "fundraising" })}
          desc={intl.formatMessage({ id: "fundraisingDesc" })}
          link={fundraisingImage}
        />
        <VolunteerCard
          flip={false}
          ...
          desc={
            <>
              {intl.formatMessage({ id: "eventsDesc" })
                .split('\n')
                .map((line, index) => (
      ...
      <div className="volunteerCardContainerMobile only-mobile">
        ...
        <VolunteerCardMobile
          title="Events"
          desc={intl.formatMessage({ id: "eventsDesc" })}
          link={eventsImage}
        />
      </div>
      ...
      <div className="volunteerFormContainer">
        <StyledFormLink text={intl.formatMessage({ id: "becomeVolunteer" })} link="#" />
      </div>
    </div>
  );
}
